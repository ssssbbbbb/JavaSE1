 ...
 *
 *  2、由于该类的构造器是private的，所以无法创建该类的对象，也就是无法实例化该类。
 ...
 *          该方法的作用是退出程序。其中status的值为0代表正常退出，非零代表异常退出。使用该方法可以
 *          在图形界面编程中实现程序的退出功能等。
 *
 *      void gc():
 *          该方法的作用是请求系统进行垃圾回收。至于系统是否立即回收，则取决于系统中垃圾回收算法的实现以及系统指向时的情况。
 *
